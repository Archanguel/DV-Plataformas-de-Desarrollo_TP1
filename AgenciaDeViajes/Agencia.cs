...
/***************************/
// LO DE ABAJO ES LO NUEVO
/***************************/
List<Alojamiento> misAlojamientos = new List<Alojamiento>();
public int cantAlojamientos;
List<Usuarios> misUsuarios = new List<Usuarios>();

public bool insertarAlojamiento(Alojamiento alojamiento){ //en esto decía +insertarAlojamiento(Alojamiento):bool
    return true; 
}
public bool eliminarAlojamiento(Alojamiento alojamiento){ //en esto decía +eliminarAlojamiento(Alojamiento):bool
    return true; 
}
public bool modificarAlojamiento(Alojamiento alojamiento){ //en esto decía +modificarAlojamiento(Alojamiento):bool
    return true; 
}
/******************************/
// LO DE ARRIBA ES LO NUEVO
/******************************/
public Agencia alojamientosEntrePrecios(float d, gloat h){}
